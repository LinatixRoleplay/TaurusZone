...
if(isset($_SESSION['User'])) 
{
	...
	$NumeroBanco = "CTA 1211-1311-00$idplayer";
}
...
<strong><font size="2px"><?php echo $Texto_Index_9;?></strong> (<i><?php echo $NumeroBanco; ?></i>)
</td>
</tr>
<tr>
...
<tbody>
<tr bgcolor="#F0F0F0"><td align="left" style="border-top: 1px solid #FFFFFF;border-left: 1px solid #FFFFFF;" colspan="4"><strong><font size="2px"><?php echo $Texto_Index_10;?></strong></td></tr>
<tr>
<td valign="middle" bgcolor="#FFFFFF" align="center"><font size="2px"><?php echo $Texto_Index_11;?></td>
...
<td valign="middle" bgcolor="#FFFFFF" align="center"><font size="2px"><?php echo $Texto_Index_12;?></td>

<?php 
	$stmt = $con->prepare("SELECT * FROM log_transacciones WHERE Enviador = :usuario OR Receptor = :usuario");
	$stmt->bindParam(':usuario', $User, PDO::PARAM_STR);
	$stmt->execute();
...
{
	$mensaje  = $NumeroBanco;
	$mensaje2 = "<font color="."#CC0000".">-$$Monto";
}else{
	$mensaje = $Enviador;
	$mensaje2 = "<font color="."#009900".">$$Monto";
}
?>
...
<?php 
	...
	{
?>
		<tr><td valign="middle" bgcolor="#FFFFFF" colspan="4"><font size="2px"><?php echo $Texto_Index_13;?></td></tr>
<?php 
	}
?>
